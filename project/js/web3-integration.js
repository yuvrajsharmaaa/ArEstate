...
const KrayStateWeb3 = {
    ...
    async tokenizeProperty(propertyId, price) {
        ...
        try {
            ...
            this.showSuccess(`Property ${propertyId} has been tokenized! Token ID: PT${propertyId}`);
            return true;
    ...
    async createLease(propertyId, tenant, monthlyRent) {
        ...
        try {
            ...
            this.showSuccess(`Lease agreement created! Tenant: ${tenant}, Monthly Rent: ${monthlyRent} ETH`);
            return true;
